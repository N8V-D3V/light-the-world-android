...
class GivingMachineDonationExperienceOrchestratorTest {
    ...
    fun addDonationSelectionRejectsCatalogFailureBeforeCartMutation() {
        val catalogProtocol = FailingDonationCatalogProtocol()
        val cartProtocol = RecordingDonationCartProtocol()
        val orchestrator = GivingMachineDonationExperienceOrchestrator(
            donationCatalogProtocol = catalogProtocol,
            donationCartProtocol = cartProtocol,
            donationCheckoutProtocol = UnusedDonationCheckoutProtocol(),
            donationReceiptProtocol = UnusedDonationReceiptProtocol(),
        )
    ...
    fun submitDonationCheckoutInvokesReceiptOnlyAfterSuccessfulCheckout() {
        ...
        val orchestrator = GivingMachineDonationExperienceOrchestrator(
            donationCatalogProtocol = FailingDonationCatalogProtocol(),
            donationCartProtocol = SuccessfulCheckoutCartProtocol(events),
            donationCheckoutProtocol = SuccessfulCheckoutProtocol(events),
            donationReceiptProtocol = SuccessfulReceiptProtocol(events),
        )
    ...
    fun submitDonationCheckoutDoesNotInvokeReceiptWhenCheckoutFails() {
        val receiptProtocol = RecordingReceiptProtocol()
        val orchestrator = GivingMachineDonationExperienceOrchestrator(
            donationCatalogProtocol = FailingDonationCatalogProtocol(),
            donationCartProtocol = SuccessfulCheckoutCartProtocol(mutableListOf()),
            donationCheckoutProtocol = FailedCheckoutProtocol(),
            donationReceiptProtocol = receiptProtocol,
        )
    ...
    private class FailingDonationCatalogProtocol : DonationCatalogProtocol {
    ...
    private class RecordingDonationCartProtocol : DonationCartProtocol {
    ...
    private class SuccessfulCheckoutCartProtocol(
    ...
    private class SuccessfulCheckoutProtocol(
        private val events: MutableList<String>,
    ...
    private class SuccessfulReceiptProtocol(
        private val events: MutableList<String>,
    ...
    private class FailedCheckoutProtocol : DonationCheckoutProtocol {
        override fun submitDonationPayment(
            donationCart: DonationCart,
            donorIdentity: DonorIdentity,
            paymentDetails: PaymentDetails,
    ...
    private class RecordingReceiptProtocol : DonationReceiptProtocol {
        var callCount: Int = 0
    ...
    private class UnusedDonationCheckoutProtocol : DonationCheckoutProtocol {
        override fun submitDonationPayment(
            donationCart: DonationCart,
            donorIdentity: DonorIdentity,
            paymentDetails: PaymentDetails,
    ...
    private class UnusedDonationReceiptProtocol : DonationReceiptProtocol {
        override fun deliverReceipt(
            donationConfirmation: DonationConfirmation?,
            receiptDeliverySelection: ReceiptDeliverySelection,
            receiptDeliveryContactInformation: ReceiptDeliveryContactInformation,
