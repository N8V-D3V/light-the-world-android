...
class DailyChallengeStubsTest {
    ...
    fun calendarModuleReturnsExplicitFailureWhenRequestedDateIsMissing() {
        val templatesWithoutDayTwelve = StubChallengeCalendar
            .defaultTemplates()
            .filterNot { it.dayOfMonth == 12 }
        val module = StubChallengeCalendar(
    ...
    fun calendarModuleFailsCardListWhenCampaignWindowContentIsIncomplete() {
        val module = StubChallengeCalendar(
            contentSource = StubChallengeCalendar.BundledChallengeContentSource(
                templates = StubChallengeCalendar.defaultTemplates().dropLast(1),
            ),
        )
    ...
    fun progressModuleUsesLocalDateForEligibilityAndRequiresConfirmedReversal() {
        val module = StubChallengeCompletionTracker(
    ...
    fun reminderModuleSchedulesBothRemindersBeforeTenAmWhenInWindowAndIncomplete() {
        val module: ChallengeReminderScheduler = StubChallengeReminderScheduler()
    ...
    fun shareModuleOnlyBuildsPayloadForCompletedChallenges() {
        val module = StubChallengeShareComposer()
