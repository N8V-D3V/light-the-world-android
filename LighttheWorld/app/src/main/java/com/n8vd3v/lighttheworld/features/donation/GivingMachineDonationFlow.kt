...
class GivingMachineDonationFlow(
    private val donationCatalog: DonationCatalog,
    private val donationCartStore: DonationCartStore,
    private val donationCheckout: DonationCheckout,
    private val donationReceiptSender: DonationReceiptSender,
    ...
    fun browseDonationOptions(
        ...
        val response = donationCatalog.getDonationOptionList(currentCatalogState)
        logger.logDecision(
            module = MODULE_NAME,
    ...
    fun viewDonationOptionDetail(
        ...
        val response = donationCatalog.getDonationOptionDetail(
    ...
    fun addDonationSelection(
        ...
        return resolveSelectionAndMutateCart(
            ...
            mutation = { selection -> donationCartStore.addSelection(selection) },
    ...
    fun updateDonationSelection(
        ...
        return resolveSelectionAndMutateCart(
            currentCatalogState = currentCatalogState,
            selectionRequest = selectionRequest,
            mutation = { selection -> donationCartStore.updateSelection(selection) },
    ...
    fun removeDonationSelection(selectedDonationOptionId: String): DonationCartExperienceResponse {
        ...
        val response = donationCartStore.removeSelection(selectedDonationOptionId)
        logger.logDecision(
            module = MODULE_NAME,
    ...
    fun reviewDonationCart(): DonationCartExperienceResponse {
        ...
        val response = donationCartStore.getCurrentCart()
        logger.logDecision(
            module = MODULE_NAME,
    ...
    fun submitDonationCheckout(
        ...
        val cartResponse = donationCartStore.validateCheckoutReady()
        ...
        val checkoutResponse = donationCheckout.submitDonationPayment(
            donationCart = cartResponse.donationCart,
            donorIdentity = donorIdentity,
            paymentDetails = paymentDetails,
            receiptDeliverySelection = receiptDeliverySelection,
        ...
        val receiptResponse = donationReceiptSender.deliverReceipt(
            donationConfirmation = checkoutResponse.donationConfirmation,
            receiptDeliverySelection = receiptDeliverySelection,
            receiptDeliveryContactInformation = receiptDeliveryContactInformation,
        )
    ...
    private fun resolveSelectionAndMutateCart(
        ...
        val optionDetailResponse = donationCatalog.getDonationOptionDetail(
            currentCatalogState = currentCatalogState,
        ...
        if (optionDetailResponse.failureResponse != null || optionDetailResponse.donationOptionDetail == null) {
            val currentCartResponse = donationCartStore.getCurrentCart()
            logger.logDecision(
                module = MODULE_NAME,
    ...
    companion object {
        private const val MODULE_NAME = "GivingMachineDonationFlow"
    }
}
