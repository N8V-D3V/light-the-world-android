...
class DailyServiceChallengeFlow(
    private val challengeCalendar: ChallengeCalendar,
    private val challengeCompletionTracker: ChallengeCompletionTracker,
    private val challengeReminderScheduler: ChallengeReminderScheduler,
    private val challengeShareComposer: ChallengeShareComposer,
    ...
    fun browseChallengeCards(
        ...
        val cardListResponse = challengeCalendar.getChallengeCardList(
    ...
    fun markChallengeCompleted(
        ...
        val progressResponse = challengeCompletionTracker.markChallengeCompleted(
    ...
    fun requestCompletionReversal(
        ...
        val promptResponse = challengeCompletionTracker.requestCompletionReversal(selectedChallengeDate)
        logger.logDecision(
            module = MODULE_NAME,
            action = "request_completion_reversal_output",
            details = mapOf(
    ...
    fun confirmCompletionReversal(
        ...
        val progressResponse = challengeCompletionTracker.confirmCompletionReversal(
            challengeDate = selectedChallengeDate,
    ...
    fun evaluateReminderSchedule(
        ...
        val progressResponse = challengeCompletionTracker.getCompletionState(
            challengeDate = currentLocalDate,
            currentLocalDate = currentLocalDate,
        )
        val currentDayChallengeResult =
            if (campaignWindow.includes(currentLocalDate)) {
                challengeCalendar.getChallengeDetail(
                    currentLocalDate = currentLocalDate,
                    campaignWindow = campaignWindow,
        ...
        val reminderResponse = challengeReminderScheduler.evaluateReminderSchedule(
    ...
    fun buildSharePayload(
        ...
        val shareResponse = challengeShareComposer.buildSharePayload(
            challengeDate = selectedChallengeDate,
    ...
    private fun loadChallengeDetailState(
        ...
        val detailResponse = challengeCalendar.getChallengeDetail(
            currentLocalDate = currentLocalDate,
            campaignWindow = campaignWindow,
            selectedChallengeDate = selectedChallengeDate,
        )
    ...
    companion object {
        private const val MODULE_NAME = "DailyServiceChallengeFlow"
    }
}
